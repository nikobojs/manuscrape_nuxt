...
export const useProjects = async (params?: RouteParams | undefined) => {
  ...
  const addCollaborator = async (
    ...
    return fetch(`/api/projects/${projectId}/collaborators`, {
      method: "POST",
  ...
  const removeCollaborator = async (
    ...
    return fetch(`/api/projects/${projectId}/collaborators/${collaboratorId}`, {
      method: "DELETE",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  const duplicateProject = async (
    ...
    return fetch(`/api/projects/${projectId}/duplicate`, {
      method: "POST",
  ...
  const deleteParameter = async (projectId: number, field: { id: number }) => {
    return fetch(`/api/projects/${projectId}/fields/${field.id}`, {
      method: "DELETE",
    });
  };

  const createParameter = async (projectId: number, field: NewProjectField) => {
    return fetch(`/api/projects/${projectId}/fields`, {
      method: "POST",
  ...
  const updateParameter = async (
    ...
    return fetch(`/api/projects/${projectId}/fields/${fieldId}`, {
      method: "PATCH",
      body: JSON.stringify(field),
      headers: {
        "Content-Type": "application/json",
  ...
  const moveParameter = async (
    ...
    return fetch(`/api/projects/${projectId}/fields/${fieldId}/move`, {
      method: "PATCH",
