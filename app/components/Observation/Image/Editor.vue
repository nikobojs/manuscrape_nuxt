<template>
  ...
  >
      ...
      <div class="flex justify-between">
        <div class="relative h-4">
          ...
          <UTooltip>
            <template #text>
              <div
                class="flex flex-col gap-y-2 py-1 max-w-xs break-words whitespace-normal"
              >
                ...
                <div class="flex gap-x-2">
                  <span class="flex gap-x-1">
                    <UKbd>Ctrl</UKbd>+<UKbd>Enter</UKbd> </span
                  >:
                ...
                <div class="flex gap-x-2">
                  <span class="flex gap-x-1">
                    <UKbd>Shift</UKbd>+<UKbd>Scroll</UKbd> </span
                  >:
                  <span>Zoom</span>
                </div>
                <div class="flex gap-x-2">
                  <span class="flex gap-x-1">
                    <UKbd>Shift</UKbd
                    >+<UKbd>W</UKbd>/<UKbd>A</UKbd>/<UKbd>S</UKbd>/<UKbd
                      >D</UKbd
                    > </span
                  >:
    ...
    <div class="w-full overflow-visible relative" ref="canvasContainer">
      ...
      >
        <div
          class="px-3 w-full h-16 right-3 flex justify-between items-center gap-x-3 bg-slate-950 bg-opacity-80"
        >
          <div class="flex items-center gap-x-3">
            ...
            <div
              ...
              v-show="modeActive(EditorMode.LINE)"
            >
              ...
              >
                <template #label> {{ lineWidth }}px </template>
              </USelectMenu>
            </div>
            ...
            <div
              class="flex items-center gap-x-3"
              v-show="modeActive(EditorMode.TEXT)"
            >
              ...
              <div class="flex flex-col items-center gap-x-2">
                ...
                <UToggle
                  ...
                  @click="
                    () => {
                      setTextDraftSolidBg(!textDraftSolidBg);
                    }
                  "
                />
              </div>
          ...
          <div class="flex gap-x-3">
            ...
            <UButtonGroup size="sm" orientation="horizontal">
              <UButton
                ...
                color="blue"
                :variant="
                  modeActive(actionMode as unknown as EditorMode)
                    ? 'solid'
                    : 'outline'
                "
                @click="
                  () => {
                    setMode(actionMode as unknown as EditorMode);
                    onActionPicked();
                  }
                "
                :disabled="modeActive(EditorMode.DISABLED)"
      ...
      <div class="w-full min-h-[480px] relative transition-all">
        ...
        <div
          role="status"
          v-show="isSaving"
          class="absolute z-5 justify-center h-full w-full flex items-center"
        >
          <svg
            aria-hidden="true"
