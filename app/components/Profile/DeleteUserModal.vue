<template>
  <UModal v-bind:model-value="open" v-on:close="onClose">
    <UCard>
      ...
      <p class="mb-4">
        Your committed observations will be kept, but no one will be able to see
        you as the author. If you are alone on some projects, they will be
        deleted permanently.
      </p>
      <UInput
        autocomplete="off"
      ...
      <div class="w-full text-right">
        <UButton color="red" @click="onDeleteUserConfirm"
          >Confirm user deletion</UButton
        >
      </div>
    </UCard>
  </UModal>
