      ...
      <div class="flex gap-x-8 items-start">
        <div class="w-80 flex gap-3 flex-col">
          ...
          <div class="grid grid-cols-2 mt-1 w-full">
            <UCheckbox class="items-center" v-model="fieldRequired" :disabled="forceFieldRequired" label="Field is required" />
        ...
        <div class="w-96">
          <div v-if="addedFields.length > 0" class="w-full">
            ...
            <div v-for="field in addedFields" class="grid grid-cols-3 gap-x-4 w-full">
...
<script setup lang="ts">
  ...
  const forceFieldRequired = computed(() => {
    if (
      fieldType.value &&
